...
- GitHubCR (IPv4 only): `docker pull ghcr.io/stefanbosak/gcp-cloud-tools:initial`
- VultrCR (IPv4 & IPv6): `docker pull sjc.vultrcr.com/developmententity/gcp-cloud-tools:initial`

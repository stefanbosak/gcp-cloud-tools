...
FROM dhi.io/debian-base:${DEBIAN_RELEASE} AS gcp-cloud-tools-builder
...
# container as builder for preparing gcp cloud tools
FROM gcp-cloud-tools-builder AS gcp-cloud-tools-cm-builder

LABEL stage="gcp-cloud-tools-cm-builder" \
      description="Debian-based container builder for preparing gcp cloud tool cert-manager CLI" \
      org.opencontainers.image.description="Debian-based container builder for preparing gcp cloud tool cert-manager CLI" \
      org.opencontainers.image.url=https://github.com/stefanbosak/gcp-cloud-tools \
      org.opencontainers.image.source=https://github.com/stefanbosak/gcp-cloud-tools
...
# container as builder for preparing gcp cloud tools
FROM gcp-cloud-tools-builder AS gcp-cloud-tools-cnpg-builder

LABEL stage="gcp-cloud-tools-cnpg-builder" \
      description="Debian-based container builder for preparing gcp cloud tool CNPG CLI" \
      org.opencontainers.image.description="Debian-based container builder for preparing gcp cloud tool CNPG CLI" \
      org.opencontainers.image.url=https://github.com/stefanbosak/gcp-cloud-tools \
      org.opencontainers.image.source=https://github.com/stefanbosak/gcp-cloud-tools
...
# container as builder for preparing kops GCP cloud tools
...
# container as builder for preparing gcp cloud tools
FROM gcp-cloud-tools-builder AS gcp-cloud-tools-kustomize-builder

LABEL stage="gcp-cloud-tools-kustomize-builder" \
      description="Debian-based container builder for preparing gcp cloud tool kustomize CLI" \
      org.opencontainers.image.description="Debian-based container builder for preparing gcp cloud tool kustomize CLI" \
      org.opencontainers.image.url=https://github.com/stefanbosak/gcp-cloud-tools \
      org.opencontainers.image.source=https://github.com/stefanbosak/gcp-cloud-tools
...
LABEL stage="gcp-cloud-tools-terragrunt-builder" \
...
# container as builder for preparing GCP cloud tools
FROM gcp-cloud-tools-builder AS gcp-cloud-tools-opentofu-builder

LABEL stage="gcp-cloud-tools-opentofu-builder" \
      description="Debian-based container builder for preparing GCP cloud tool OpenTofu" \
      org.opencontainers.image.description="Debian-based container builder for preparing GCP cloud tool OpenTofu" \
      org.opencontainers.image.url=https://github.com/stefanbosak/gcp-cloud-tools \
      org.opencontainers.image.source=https://github.com/stefanbosak/gcp-cloud-tools
...
COPY --from=gcp-cloud-tools-ansible-cli-builder "/usr/local/share/uv/tools" "/usr/local/share/uv/tools"
...
COPY --from=gcp-cloud-tools-opentofu-builder "/usr/local/bin/" "/usr/local/bin/"
...
COPY ./scripts "${HOME_ROOT_DIR}/scripts"
